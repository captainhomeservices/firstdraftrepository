...
const BlogPost: React.FC<BlogPostProps> = ({
  ...
  const processContent = (content: string) => {
    ...
    const internalLinks: Record<string, string> = {
      ...
      'TPWD and LCRA permits': '/permitting',
      'TPWD permit': '/permitting',
      'aquatic vegetation removal permit': '/permitting',
      ...
      'hydrilla root removal': '/how-it-works',
      'root-based removal': '/how-it-works',
      'root extraction': '/how-it-works',
      'manual removal process': '/how-it-works',
      'aquatic vegetation management': '/contact',
      'benthic barriers': '/benthic-barriers',
      'lake bottom blankets': '/benthic-barriers',
      'benthic barrier': '/benthic-barriers',
      'LakeMat': '/benthic-barriers',
    };
