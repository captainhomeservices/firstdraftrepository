        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Our{" "}
                <Link to="/how-it-works" onClick={scrollToTop} className="text-green-600 hover:text-green-700 font-semibold underline">manual removal methods</Link>{" "}
                and{" "}
                <Link to="/benthic-barriers" onClick={scrollToTop} className="text-emerald-600 hover:text-emerald-700 font-semibold underline">benthic barrier installations</Link>{" "}
                are all fully permitted.
              </p>
          ...
          <div className="bg-green-50 rounded-lg p-8">
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-lg text-gray-700 max-w-4xl mx-auto">
                ...
                <Link to="/how-it-works" onClick={scrollToTop} className="text-green-600 hover:text-green-700 font-semibold underline">removal process</Link>,{" "}
                <Link to="/benthic-barriers" onClick={scrollToTop} className="text-emerald-600 hover:text-emerald-700 font-semibold underline">benthic barriers</Link>, and read our{" "}
                <Link to="/blog" onClick={scrollToTop} className="text-teal-600 hover:text-teal-700 font-semibold underline">blog</Link>{" "}
                for helpful tips.
              </p>
            </div>
          </div>
