        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 bg-teal-50 rounded-xl border border-teal-100">
              ...
              <p className="text-gray-700 leading-relaxed">
                Professional <strong>lake management</strong> strategies,{" "}
                <Link to="/permitting" onClick={scrollToTop} className="text-teal-600 hover:text-teal-700 font-semibold underline">permitting guidance</Link>, and sustainable waterfront maintenance practices.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            <strong>Captain Home Services</strong> provides expert{" "}
            <Link to="/how-it-works" onClick={scrollToTop} className="text-green-600 hover:text-green-700 font-semibold underline">manual lake weed removal</Link>{" "}
            and{" "}
            <Link to="/benthic-barriers" onClick={scrollToTop} className="text-emerald-600 hover:text-emerald-700 font-semibold underline">benthic barrier installation</Link>{" "}
            throughout the Highland Lakes. All work is{" "}
            <Link to="/permitting" onClick={scrollToTop} className="text-blue-600 hover:text-blue-700 font-semibold underline">fully permitted</Link>.
          </p>
