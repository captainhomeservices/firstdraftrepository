        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="bg-emerald-50 border-l-4 border-emerald-500 p-4">
                <p className="text-emerald-900 font-semibold">
                  <strong>Captain Home Services</strong> pulls invasive vegetation by the roots with minimal fragmentation, then installs{" "}
                  <Link to="/benthic-barriers" onClick={scrollToTop} className="text-emerald-700 hover:text-emerald-800 underline">benthic barriers</Link>{" "}
                  (when applicable) for complete long-term control. All work is{" "}
                  <Link to="/permitting" onClick={scrollToTop} className="text-emerald-700 hover:text-emerald-800 underline">fully permitted</Link>.
                </p>
              </div>
            </div>
            <div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-16">
            ...
            <p className="text-center text-gray-600 mb-6 max-w-3xl mx-auto">
              Read more about these invasive species in our{" "}
              <Link to="/blog" onClick={scrollToTop} className="text-teal-600 hover:text-teal-700 font-semibold underline">educational blog</Link>{" "}
              or check out our{" "}
              <Link to="/blog/lake-weed-removal-faq" onClick={scrollToTop} className="text-teal-600 hover:text-teal-700 font-semibold underline">FAQ page</Link>{" "}
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            ...
            <Link to="/benthic-barriers" onClick={scrollToTop} className="text-white hover:text-emerald-200 font-semibold underline">benthic barriers</Link>{" "}
            (when applicable) = long-term hydrilla control. All work is{" "}
            <Link to="/permitting" onClick={scrollToTop} className="text-white hover:text-blue-200 font-semibold underline">fully permitted</Link>.{" "}
            Restore your lakefront's health and beauty.
          </p>
