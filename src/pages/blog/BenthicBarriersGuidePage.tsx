      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="list-disc pl-6 mb-8 space-y-3 text-gray-700">
            ...
            <li>
              <strong>We handle all permits</strong>: Every installation is{' '}
              <Link to="/permitting" onClick={scrollToTop} className="text-blue-600 hover:text-blue-700 underline">
                fully permitted through TPWD
              </Link>
